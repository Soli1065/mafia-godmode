...
import 'package:mafia_godmode/features/gm_panel/gm_panel_screen.dart';
import 'package:mafia_godmode/features/setup/setup_screen.dart';
    ...
    final router = GoRouter(
      routes: [
        ShellRoute(
          ...
          routes: [
            GoRoute(path: '/', builder: (c, s) => const SetupScreen()),
            GoRoute(path: '/catalog', builder: (c, s) => const CatalogScreen()),
            GoRoute(path: '/assignment', builder: (c, s) => const AssignmentScreen()),
            GoRoute(path: '/gm', builder: (c, s) => const GmPanelScreen()),
